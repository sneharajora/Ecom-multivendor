  ...
  const updateScrollButtons = () => {
    ...
    if (container) {
      ...
      const rightScrollable =
        container.scrollableWidth > leftScroll + container.clientWidth;
    ...
    <section className="py-16 px-4 lg:px-0">
      <div className="container mx-auto text-center mb-10 relative">
        ...
        <p className="text-lg text-gray-600 mb-8">
          Discover the latest styles staright offf the runway, freshly added to
        ...
        {newArrivals.map((product) => (
          ...
          >
            <img
              ...
              draggable="false"
            />
            <div className="absolute bottom-0 left-0 right-0 bg-opacity-50 backdrop-blur-md text-white p-4 rounded-b-large">
